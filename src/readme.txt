...
./main -est -config training0.properties
  
./main -est -config training.properties
 ./main -est -config cameratraining.properties
 ./main -est -config cameratraining0.properties
 ./main -est -config tablettraining.properties
 ./main -est -config tvtraining.properties
 ./main -est -config phonetraining.properties


 ./main -inf -config cameratest.properties 
 ./main -inf -config tvtest.properties
 ./main -inf -config tablettest.properties
 ./main -inf -config phonetest.properties
...
for estimation), execute:
 ...
 ./main -inf -config test.properties    
